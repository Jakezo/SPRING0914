...
public class Controller {
	...
	/*
		ModelAndView 클래스
		1. 스프링 2 이전에 사용하던 클래스로 (아마도) 현재 많이 생산되어 있는 코드입니다.
		...
		4. Model은 request라고 생각하시면 편합니다.
		   - Model은 Controller가 JSP에게 전달하고자 하는 데이터를 속성(attribute)으로 저장하는 클래스입니다.
	...
	*/
	...
	// 1. 단순 이동
	@RequestMapping("v01")	// Mapping과 이동경로가 달라도 전혀 상관이 없습니다.
